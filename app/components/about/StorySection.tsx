...
export default function StorySection() {
  return (
    <section className="pt-8 md:pt-12 pb-20 md:pb-32 bg-stone-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 animate-fade-in-left">
            ...
            <div className="mt-10">
              <div className="relative w-48 h-16 opacity-60 grayscale">
                <Image
              ...
              <p className="mt-2 ml-7 text-sm text-stone-400 uppercase tracking-widest">
                AAKAR Team
              </p>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2 relative animate-fade-in-right">
            ...
            <div className="absolute -bottom-8 -left-8 w-40 h-40 bg-white p-3 hidden md:block shadow-xl group hover:scale-105 transition-transform duration-300 cursor-pointer">
              <Image
                src="/image_02-1.webp"
