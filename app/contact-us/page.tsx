            ...
            <div className="bg-white p-8 md:p-12 shadow-sm border border-stone-100">
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-[#6D3A22] to-[#5A2F1A] disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold px-4 sm:px-5 py-1.5 sm:py-2 rounded-md shadow-sm hover:shadow-md disabled:shadow-none transition-all duration-300 hover:scale-105 disabled:hover:scale-100 disabled:cursor-not-allowed flex items-center justify-center gap-1.5 group relative overflow-hidden text-xs sm:text-sm mt-4"
                >
